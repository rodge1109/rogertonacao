  ...
  return (
    <CartContext.Provider value={contextValue}>
      <style>{`
        ...
        .scrollbar-hide::-webkit-scrollbar { display: none; }
      `}</style>
      <div className="min-h-screen bg-stone-900 pb-16 md:pb-0">
        <Header
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-stone-900 border-t border-white/10 md:hidden z-50 pb-safe">
          <div className="flex justify-around items-center py-2">
            <button
              onClick={() => setCurrentPage('home')}
              className={`flex flex-col items-center px-4 py-1 ${currentPage === 'home' ? 'text-[#E4FE7B]' : 'text-white/60'}`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center px-4 py-1 ${currentPage === 'menu' ? 'text-[#E4FE7B]' : 'text-white/60'}`}
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex flex-col items-center px-4 py-1 text-white/60"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
